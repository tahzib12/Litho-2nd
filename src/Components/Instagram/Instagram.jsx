...
const Instagram = (props) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const url = await fetch(`https://graph.instagram.com/me/media?fields=id,media_type,media_url,timestamp,permalink,comments_count,like_count&access_token=${process.env.REACT_APP_INSTA_API_KEY}`);
