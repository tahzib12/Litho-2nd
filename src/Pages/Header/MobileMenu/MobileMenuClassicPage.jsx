  ...
  return (
    <div style={props.style}>
      ...
      <Header topSpace={{ md: true }} type="reverse-scroll">
        <HeaderNav theme="dark" expand="lg" containerClass="sm:px-0" className="py-[0px] md:py-[20px]">
          ...
          <Navbar.Toggle className="order-last md:px-[25px]">
          ...
          <Col className="col-auto col-lg-2 text-end pe-0 md:mr-[10px]">
            <SocialIcons theme="social-icon-style-01" className="justify-end" size="xs" iconColor="light" data={SocialIconsData} />
          </Col>
        </HeaderNav>
      </Header>
      {/* Header End */}
