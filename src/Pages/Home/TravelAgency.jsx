  ...
  return (
    <div style={props.style}>
      ...
      <div className="bg-white">
        ...
        {/* About section Start */}
        <section className="overflow-hidden py-[130px] bg-no-repeat bg-left-bottom lg:py-[90px] md:py-[75px] sm:py-[50px]" style={{ backgroundImage: `url(https://via.placeholder.com/1075x517)` }}>
          <Container>
            <Row className="justify-center items-center z-index-0 relative">
              <Col lg={6} className="relative z-[1] md:mb-[50px] sm:mb-[35px]">
                <TiltBox className="relative p-0">
                  <img width={555} height={426} src="https://via.placeholder.com/850x653" alt='vacation' />
                </TiltBox>
                <div className="absolute top-1/2 left-1/2 flex justify-center items-center">
                  ...
                  <CustomModal.Wrapper
                    ...
                    modalBtn={<Buttons ariaLabel="modal link" type="submit" className="btn-sonar border-0" themeColor="#fff" color="#ff7a56" size="lg" title={<i className="icon-control-play" />} />} >
              ...
              <div className="col-lg-5 offset-lg-1" >
                <m.h2 className="heading-5 font-serif font-medium text-darkgray w-[80%] mb-[45px] -tracking-[.5px] lg:w-[90%] md:mb-[35px]" {...{ ...fadeInLeft, transition: { ease: "circOut", duration: 1.2 } }}>Litho specializes in small <span className="font-bold">group vacations</span></m.h2>
                <Lists className="travel-agency-list-style" theme="list-style-07" data={ListData} animation={fadeInLeft} animationDelay={0.3} />
                <m.div className="items-center flex" {...{ ...fadeInLeft, transition: { initial: { opacity: 0, x: "100%" }, delay: 0.7, ease: 'circOut', duration: 1 } }}>
                  <Buttons ariaLabel="link for about" href="#" className="btn-fancy btn-fill font-medium font-serif rounded-none uppercase mr-[35px] md:mb-0 tracking-[.5px] py-[10px] px-[24px]" themeColor="#232323" color="#fff" size="sm" title="About company" />
                  <Buttons ariaLabel="link for about" href="#" className="font-medium font-serif uppercase btn-link after:h-[2px] top-[-5px] text-md after:bg-darkgray md:pt-0 hover:text-darkgray" size="xl" color="#232323" title="Discover tour" />
                </m.div>
              </div>
            </Row>
          </Container>
