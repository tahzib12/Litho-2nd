...
// Data
import { FashionShopData, filterData } from "../../Components/Products/ProductData";
...
const blogClassicData = blogData.filter(item => item.blogType === "classic").filter(item => item.category.includes("fashionshop"));
    ...
    <div style={props.style}>
      ...
      <Header topSpace={{ desktop: true }} type="reverse-scroll">
        <Topbar className="bg-darkgray py-[8px] border-b border-[#0000001a] sm:hidden md:px-0">
          <Container fluid className="px-[50px] lg:pr-[65px] font-sans md:px-[30px]">
            <Row>
              <Col sm="auto" className="text-center sm:text-start flex items-center">
                <p className="text-md m-0"><span className="font-medium text-white">Offer: </span>Worldwide free shipping for all orders of $150</p>
              </Col>
              <Col className="sm:block text-end lg:px-0">
                <div>
                  <span className="mr-[25px] md:pr-0 text-sm md:mr-[15px]">
                    <i className="feather-phone-call text-md mr-[7px] text-white"></i>0222 8899900
                  </span>
        ...
        <HeaderNav fluid="fluid" theme="light" bg="white" menu="light" className="px-[35px] py-[0px] md:pl-0 md:pr-[15px]" containerClass="pl-[15px] sm:px-0">
        ...
        >
          {
            swiperData.map((item, i) => {
              return (
                <SwiperSlide key={i} className="bg-mediumgray h-full overflow-hidden flex items-center md:items-end justify-center transition-default xs:items-start landscape:md:items-start">
                  {/* Big Circle End */}
                  <m.svg
                  ...
                  >
                    <defs>
                      <linearGradient id="gradient-one" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" style={{ stopColor: "rgba(235, 60, 119, 1)" }}></stop>
                        <stop offset="100%" style={{ stopColor: "rgba(245, 147, 23, 1)" }}></stop>
                      </linearGradient>
                    </defs>
                    <m.path
                  ...
                  >
                    <defs>
                      <linearGradient id="gradient-two" x1="0%" y1="0%" x2="0%" y2="100%">
                        ...
                        <stop offset="100%" style={{ stopColor: "#9f2dfa" }}></stop>
                      </linearGradient>
                    </defs>
                    <m.path
                  ...
                  <Container className="sm:relative">
                    <Row className="items-center font-serif sm:justify-center">
                      <Col lg={6} xs={12} className="text-darkgray overflow-hidden md:text-center">
                        ...
                        <m.span
                          ...
                          className="text-lg -tracking-[1px] text-gradient mb-[45px] inline-block bg-gradient-to-r from-[#ff6557] to-[#ff367c] font-medium md:text-center md:text-sm md:mb-[15px] xs:tracking-0">{item.subTitle}</m.span>
                        <m.h2 className="heading-6 font-medium leading-[85px] -tracking-[4px] mb-[60px] text-[90px] lg:text-[80px] lg:leading-none md:text-[45px] sm:text-[44px] md:text-center md:mb-[30px]"
                          initial={{ clipPath: 'polygon(0 0, 0 0, 0 100%, 0% 100%)' }}
                          whileInView={{ clipPath: 'polygon(0 0, 100% 0, 100% 100%, 0 100%)', }}
                          transition={{ duration: 0.7, ease: "easeOut" }}
                        ><span className="block">{item.titleOne}</span>{item.titleTwo}</m.h2>
                        <m.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.5, ease: "easeOut" }}>
                          <Buttons aria-label="link for" to="/shop/shop-wide/" className="font-medium font-serif uppercase rounded-none bg-white hover:text-black hover:bg-white md:relative md:mb-5" size="md" themeColor="#fff" color="#000" title="SHOP COLLECTION" />
                        </m.div>
                      </Col>
                      <Col lg={6} xs={12} className="p-0 m-0 md:h-[50vh] md:relative xs:h-[45vh]">
                        <m.img
                          alt="hero"
      ...
      <section className="relative pt-0 lg:py-[90px] md:py-[75px] sm:py-[50px] px-[5.5rem] lg:px-8 sm:p-0 py-0">
        <Container fluid>
          <Row>
            <Col>
              <OnlyCategories overlay={["#f84e30cc", "#d76a57cc", "#fff"]} grid="grid grid-4col xl-grid-4col lg-grid-2col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large" data={shopCategoriesData} />
            </Col>
          </Row>
        </Container>
      </section>
      ...
      {/* Section Start */}
      <m.section className="relative py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px] xs:px-0 px-[4.5rem] lg:px-[1.5rem] sm:px-0"{...fadeIn}>
        <Container fluid>
          <Row>
            <Col className="text-center fashionshop-shopwide xs:px-0">
              <ShopWide filterData={filterData} grid="grid grid-5col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-extra-large" data={FashionShopData} />
              <Buttons aria-label="link for" href="/shop/left-sidebar/" className="mx-3 font-medium font-serif tracking-[0.5px] btn-fancy uppercase rounded-none md:mb-[15px] bg-[#fff]" color="#000" size="md" themeColor="#000" title="More Collection" />
            </Col>
          </Row>
        </Container>
      </m.section>
        ...
        <Container>
          <Row lg={2} xs={1} className="gap-y-10">
            <m.div className="col" {...fadeIn}>
              <div className="flex items-center cover-background h-full" style={{ backgroundImage: 'url(https://via.placeholder.com/1000x540)' }}>
                <div className="w-3/5 font-serif p-20 lg:px-12 md:w-2/5 md:py-28 sm:w-[70%] xs:w-4/5">
                  <span className="font-medium text-sm text-darkgray opacity-60 uppercase block mb-[15px]">New fashion</span>
                  <h2 className="heading-6 text-[30px] leading-[33px] mb-[24px] font-semibold text-darkgray xs:text-xlg xs:mb-[15px]">Summer <span className="block">collection</span></h2>
                  <Buttons aria-label="link for" href="/shop/shop-wide/" className="btn-fill btn-fancy uppercase rounded-none btn-shadow" size="sm" themeColor="#fff" color="#000" title="SHOP COLLECTION" />
                </div>
              </div>
            </m.div>
            <m.div className="col"{...{ ...fadeIn, transition: { delay: 0.6 } }}>
              <div className="flex items-center cover-background h-full" style={{ backgroundImage: 'url(https://via.placeholder.com/1000x540)' }}>
                <div className="w-3/5 md:w-2/5 sm:w-[70%] p-20 lg:px-[3rem] md:py-[7rem]">
                  {/* Modal Component Start */}
                  <CustomModal.Wrapper className="mb-10"
                    modalBtn={
                      <span className="inline-flex flex-row items-center justify-center">
                        <Buttons aria-label="link for" type="submit" className="btn-sonar border-0 mr-[15px]" themeColor="#fff" color="#FD5762" size="md" title={<i className="fas fa-play text-[15px] !ml-[5px]" />} />
                      </span>
                    }>
                  ...
                  <h2 className="heading-6 font-serif font-light text-white mb-0 leading-[34px] xs:text-xlg" >Fashion <span className="text-[30px] font-semibold block xs:text-xlg">Lookbook</span></h2>
                </div>
              </div>
            </m.div>
          </Row>
        ...
        <Container>
          <Row className="items-center justify-between gap-y-10 md:justify-center">
            <Col lg={3} className="col-lg-3 text-center lg:px-0">
              <m.h1 className="heading-5 font-serif text-darkgray font-semibold tracking-[-1px] inline-block mb-0 w-[95%]" {...fadeIn}>Don't miss out on this deal</m.h1>
            </Col>
            <m.div className="col-auto" {...{ ...fadeIn, transition: { delay: 0.5 } }}>
              <CountDown
                theme="countdown-style-02 font-serif"
                className="text-darkgray justify-center"
                date="2023-04-29T15:02:03" />
            </m.div>
            <m.div className="col-xl-3 flex justify-end lg:justify-center" {...{ ...fadeIn, transition: { delay: 0.7 } }}>
              <Buttons aria-label="link for" href="/shop/shop-wide" className="btn-fill btn-fancy font-medium font-serif rounded-none uppercase md:mb-[15px]" themeColor="#232323" color="#fff" size="lg" title="Shop Collection" />
            </m.div>
          </Row>
        </Container>
      </section>
        ...
        <Container>
          <Row className="justify-center mb-20 xs:mb-0">
            <div className="text-center mb-16 md:mb-12">
              <h2 className="heading-4 font-serif text-center font-semibold text-darkgray -tracking-[1px]">Love fashion story</h2>
            </div>
            <Col xs={12} className="md:px-0">
              <BlogClassic pagination={false} grid="grid grid-4col xl-grid-4col lg-grid-3col md-grid-2col sm-grid-2col xs-grid-1col gutter-double-extra-large xs:px-0" data={blogClassicData} />
            </Col>
          </Row>
        </Container>
      </section>
                      ...
                      {({ isSubmitting, status }) => (
                        <div className="relative subscribe-style-05">
                          <Form className="relative mb-[25px]">
                            ...
                            <AnimatePresence>
                              {status && <m.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}><MessageBox className="absolute mt-[10px] py-[10px] !z-[1] text-md" theme="message-box01" variant="success" message="Your message has been sent successfully!" /></m.div>}
                            </AnimatePresence>
                          </Form>
                        </div>
                      )}
      ...
      <section className="bg-darkgray sm:bg-white">
            ...
            <Overlap className="sm:mt-0 mx-0 bg-gradient-to-t from-[#ff6557] via-[#ff4e68] to-[#ff367c] rounded-[6px] py-[60px] md:p-10 relative">
              <Row className="justify-center items-center">
                <Col lg={5} className="md:mb-[30px] xs:px-0">
                  <h2 className="heading-6 font-serif text-[2.3rem] leading-[40px] font-light text-white mb-0 text-start md:text-center w-11/12 xs:leading-[3rem] xs:w-full"><span className="font-semibold">Join our newsletter</span> and get 15% sale discount</h2>
                </Col>
                <Col lg={5}>
                  <Formik
                    initialValues={{ email: '' }}
                    ...
                    {({ isSubmitting, status }) => (
                      <div className="relative subscribe-style-05 w-[90%] lg:w-full">
                        <Form className="relative">
                          ...
                          <button aria-label="subscibe btn" type="submit" className={`text-lg tracking-[1px] !border-l-0 py-[12px] px-[28px] uppercase xs:text-center${isSubmitting ? " loading" : ""}`}><i className="far fa-envelope text-neonorange text-lg leading-none"></i></button>
                        </Form>
                        <AnimatePresence>
                          {status && <m.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="absolute top-[115%] left-0 w-full z-[2]"><MessageBox className="rounded-[4px] text-md py-[10px] px-[22px] !z-[1]" theme="message-box01" variant="success" message="Your message has been sent successfully subscribed to our email list!" /></m.div>}
                        </AnimatePresence>
                      </div>
                    )}
                  </Formik>
        ...
        {/* Footer Start */}
        <FooterStyle07 className="fashionshop-footer text-[#828282] bg-darkgray" logo="/assets/img/webp/logo-white.webp" theme="dark" />
        {/* Footer End */}
      </section>
      {/* Section End */}
    </div>
