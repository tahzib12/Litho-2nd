        ...
        <>
            ...
            <section className="bg-darkgray py-[25px]">
                <Container>
                    <Row className="items-center justify-center mb-0">
                        <Col xl={8} lg={6}>
                            <h1 className="font-serif text-white font-medium mb-0 md:text-center text-lg">Countdown</h1>
                        </Col>
            ...
            <section className="bg-darkgray py-[160px] lg:py-[120px] md:py-[95px] sm:py-[80px] xs:py-[50px]">
                <Container>
                    <Row>
                        <Col className="mb-[6%]">
                            <h6 className="font-serif text-white text-center font-medium mb-[25px] lg:mb-[15px]">Countdown style 01</h6>
                        </Col>
                    </Row>
            ...
            <section className="py-[160px] lg:py-[120px] md:py-[95px] sm:py-[80px] xs:py-[50px]">
                <Container>
                    <Row>
                        <Col className="mb-[6%]">
                            <h6 className="font-serif text-darkgray text-center font-medium mb-[25px] lg:mb-[15px]">Countdown style 02</h6>
                        </Col>
                    </Row>
                    <CountDown
                        theme="countdown-style-02"
                        className="text-darkgray font-serif justify-center mb-[40px] xs:mb-0"
                        date="2023-04-18T04:30:40"
                        animation={fadeIn}
                    />
                </Container>
            </section>
            <section className="bg-darkslateblue py-[160px] lg:py-[120px] md:py-[95px] sm:py-[80px] xs:py-[50px]">
                <Container>
                    <Row>
                        <Col className="mb-[6%]">
                            <h6 className="font-serif text-white text-center font-medium mb-[25px] lg:mb-[15px]">Countdown style 03</h6>
                        </Col>
                    </Row>
