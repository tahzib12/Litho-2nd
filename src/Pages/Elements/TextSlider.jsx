    ...
    <>
      ...
      <section className="bg-darkgray py-[25px]">
        <Container>
          <Row className="items-center justify-center mb-0">
            <Col xl={8} lg={6}>
              <h1 className="font-serif text-white font-medium mb-0 md:text-center text-lg">Text slider</h1>
            </Col>
      ...
      <m.section className=" py-[160px] lg:py-[120px] md:py-[95px] sm:py-[80px] xs:py-[50px]" {...fadeIn}>
        <Container fluid className="px-0">
          <Row className="mb-[5%]">
            <Col>
              <h6 className="font-serif text-darkgray text-center font-medium">Text slider style 01</h6>
            </Col>
          </Row>
          <TextSlider01
      ...
      {/* Section Start */}
      <m.section className="py-[160px] border-t overflow-hidden lg:py-[120px] md:py-[95px] sm:py-[80px] xs:py-[50px]" {...fadeIn}>
        <Container fluid className="px-0">
          <Row className="justify-center">
            <Col md={12} className="text-center mb-[5%]">
              <h6 className="font-serif text-darkgray font-medium">Text slider style 02</h6>
            </Col>
          </Row>
          <TextSlider02
      ...
      {/* Section Start */}
      <m.section className="py-[120px] lg:py-[95px] md:py-[80px] sm:py-[50px] bg-lightgray" {...fadeIn}>
        <Container fluid className="px-0">
          <h6 className="font-serif text-gray-900 text-center font-medium mb-24">Text Slider style 03</h6>
          <TextSlider03
      ...
      <section className="overflow-hidden py-[130px] lg:py-[90px] md:py-[75px] xs:py-[50px]">
        <Row className="justify-center">
          <Col md={12} className="text-center mb-[5%]">
            <h6 className="font-serif text-darkgray font-medium">Text slider style 04</h6>
          </Col>
        </Row>
        <Row className="g-0">
          <div className="col-xl-6 bg-cover lg:h-[600px] md:h-[500px] sm:h-[350px] relative" style={{ backgroundImage: 'url(https://via.placeholder.com/950x668)' }}></div>
          <Col xl={6} className="relative p-0">
            ...
            <Swiper ref={swiperReff} loop={true} modules={[Autoplay]} autoHeight={false} className="black-move">
              <SwiperSlide className="cover-background h-full" style={{ backgroundImage: 'url(https://via.placeholder.com/950x668)' }}>
      ...
      <section className="pb-0 bg-lightgray overflow-hidden py-[130px] lg:py-[90px] md:py-[75px] xs:py-[50px]">
        <Container fluid>
          <Row className="justify-center">
            <Col md={12} className="text-center mb-[5%]">
              <h6 className="font-serif text-darkgray font-medium">Text slider style 05</h6>
            </Col>
          </Row>
          <Row>
            <m.div className="col-xs-12 col-xl-6 col-lg-5 cover-background pl-40 h-[650px] flex flex-col justify-center xl:pl-[15px] lg:h-[550px] md:h-[350px] xs:h-[300px]" style={{ backgroundImage: `url(https://via.placeholder.com/1100x745)` }} {...fadeIn}>
              <Row className="justify-center">
                <Col xl={5} sm={9} className="xs:text-center">
                  ...
                  <h4 className="font-serif font-medium text-white mb-0 xs:w-[70%] mx-auto">Five reasons to stay with us</h4>
                </Col>
              </Row>
            </m.div>
            ...
            <m.div className="col-xl-6 col-lg-7 px-0 relative" {...{ ...fadeIn, transition: { delay: 0.6 } }}>
              <Swiper
                ...
                <SwiperSlide className="overflow-hidden cover-background relative" style={{ backgroundImage: `url(https://via.placeholder.com/1100x745)` }}>
                  <div className="flex flex-col justify-end h-full" >
                    <div className="bg-white pl-24 pr-20 py-[4.5rem] w-[55%] lg:w-[75%] lg:py-[3.5rem] lg:px-16 md:w-[60%] sm:w-[75%] xs:w-[80%]">
                      <h6 className="font-serif font-medium text-[#333045] mb-[15px]">Exclusive restaurants</h6>
                      <p className="w-[90%] sm:w-full">Lorem ipsum dolor amet consectetur adipiscing do eiusmod tempor incididunt ut labore magna Ut enim minim nostrud exercitation ullamco laboris nisiex ea commodo consequat.</p>
                    </div>
                  </div>
                </SwiperSlide>
                <SwiperSlide className="overflow-hidden cover-background relative" style={{ backgroundImage: `url(https://via.placeholder.com/1100x745)` }}>
                  <div className="flex flex-col justify-end h-full" >
                    <div className="bg-white px-24 py-[4.5rem] w-[55%] lg:w-[75%] lg:py-[3.5rem] lg:px-16 md:w-[60%] sm:w-[75%] xs:w-[80%]">
                      <h6 className="font-serif font-medium text-[#333045] mb-[15px]">Large swimming pool</h6>
                      <p className="w-[90%] sm:w-full">Lorem ipsum dolor amet consectetur adipiscing do eiusmod tempor incididunt ut labore magna Ut enim minim nostrud exercitation ullamco laboris nisiex ea commodo consequat.</p>
                    </div>
                  </div>
                </SwiperSlide>
                <SwiperSlide className="overflow-hidden cover-background relative" style={{ backgroundImage: `url(https://via.placeholder.com/1100x745)` }}>
                  <div className="flex flex-col justify-end h-full" >
                    <div className="bg-white px-24 py-[4.5rem] w-[55%] lg:w-[75%] lg:py-[3.5rem] lg:px-16 md:w-[60%] sm:w-[75%] xs:w-[80%]">
                      <h6 className="font-serif font-medium text-[#333045] mb-[15px]">Luxury spa massage</h6>
                      <p className="w-[90%] sm:w-full">Lorem ipsum dolor amet consectetur adipiscing do eiusmod tempor incididunt ut labore magna Ut enim minim nostrud exercitation ullamco laboris nisiex ea commodo consequat.</p>
                    </div>
                  </div>
                </SwiperSlide>
