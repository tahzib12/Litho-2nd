        ...
        <>
            ...
            <Header topSpace={{ md: true }} className="absolute w-full top-0 z-[15]">
                <HeaderNav theme="light" fluid="fluid" expand="lg" className="h-[120px] items-center md:h-[80px] xs:h-auto px-[50px] md:px-0 md:py-[15px]">
                    ...
                    <Col xs="auto" className="text-right pr-0 items-center md:!px-0 xs:hidden">
                        <Buttons href="https://1.envato.market/AL7Oj" target="_blank" className="font-medium font-serif uppercase rounded-[2px]" themeColor={["#556fff", "#ff798e"]} size="lg" color="#fff" title="Purchase litho" />
                    </Col>
                </HeaderNav>
            </Header>
            {/* Header End */}
            ...
            <div className="bg-white">
                ...
                <section className='relative md:overflow-hidden'>
                    ...
                    <div className="relative md:flex md:items-center overflow-hidden sm:h-auto" >
                        ...
                        <Container className="relative z-[2]">
                            <Row>
                                <Col xl={6} lg={7} md={10} className="flex flex-col justify-center full-screen relative z-[1] lg:h-[700px] sm:h-[500px]">
                                    <div className="font-serif text-lg font-semibold uppercase mb-[40px] flex sm:mb-[25px]">
                                        ...
                                        <div className="flex-grow-1">
                                            <span className="text-gradient bg-gradient-to-r from-[#556fff] via-[#e05fc4] to-[#ff798e] -tracking-[.5px]">Truly Handcrafted</span>
                                        </div>
                                    </div>
                                    <h1 className="heading-2 font-serif text-darkgray -tracking-[2px] font-semibold mb-[10px] sm:mb-[5px]">Create anything</h1>
                                    <h2 className="heading-3 font-serif text-darkgray -tracking-[2px] mb-[40px] sm:mb-[25px]">that you can imagine</h2>
                                    ...
                                    <CustomModal.Wrapper
                                        className="absolute bottom-[100px] sm:bottom-[50px]"
                                        modalBtn={
                                            <span className="inline-flex flex-row items-center justify-center z-[5] cursor-pointer">
                                                <Buttons
                                                    ...
                                                    Color="#232323"
                                                    size="md"
                                                    ariaLabel="Explore litho"
                                                    title={<i className="fas fa-play text-[20px] text-gradient bg-gradient-to-r from-[#556fff] to-[#ff798e]" />}
                                                />
                ...
                <section id="demos" className="relative demo-filter-color py-[160px] overflow-hidden lg:py-[120px] md:py-[95px] sm:py-[80px] xs:py-[50px]">
                    <Container fluid className="px-[7%] xl:px-[4%] lg:px-[2%] sm:px-[15px]">
                        <m.div className="row justify-center" {...fadeIn}>
                            <Col xs={10} lg={3} sm={6} className="font-serif text-center mb-20 md:mb-12">
                    ...
                    <Container>
                        <m.div className="row items-center justify-center" {...fadeIn}>
                            <Col xl={4} lg={5} md={8} className="md:mb-20 md:text-center">
                                ...
                                <p className="text-xmd leading-[32px] w-[95%] mx-auto mb-0">Choose the most suitable template from the great collection of beautiful templates.</p>
                                ...
                                <p className="text-xmd leading-[32px] w-[95%] mx-auto mb-0">Create your website in minutes by using readymade inner pages and save time.</p>
                                <Buttons href="#templates" className="mt-[4.5rem] btn-fill font-medium font-serif tracking-[1px] rounded-none uppercase md:mb-[15px]" themeColor="#232323" color="#fff" size="lg" title="Explore Now" />
                            </Col>
                    ...
                    <Container>
                        <m.div className="row items-center justify-center" {...fadeIn}>
                            <Col xl={4} lg={5} md={8} className="md:mb-20 md:text-center">
                                ...
                                <p className="text-xmd leading-[32px]">Lorem ipsum is simply dummy text of the printing and typesetting industry. lorem ipsum has been the industry's standard dummy text ever since the when an unknown printer took specimen book. </p>
                ...
                <section id="features" className="bg-[#f4f5f9] py-[130px] lg:py-[95px] md:py-[75px] sm:py-[50px]">
                    <Container>
                        <m.div className="row justify-center" {...fadeIn}>
                            <Col lg={5} sm={6} className="font-serif text-center mb-20 md:mb-12">
                ...
                <section id="templates" className="bg-[#e1e2e9] overflow-hidden pb-0 py-[130px] lg:py-[95px] md:py-[75px] sm:py-[50px]">
                    <Container>
                        <m.div className="row justify-center" {...fadeIn}>
                            <Col xl={6} lg={7} sm={9} className="font-serif text-center mb-20 md:mb-12 sm:mb-0">
                ...
                <section className="bg-white overflow-hidden py-[160px] lg:py-[120px] md:py-[95px] sm:py-[75px] xs:py-[50px] relative">
                    ...
                    <Container>
                        <Row className="justify-center">
                            <Col lg={8} className="col-12 text-center mb-[9.5rem] md:mb-10">
                                <m.h2 className="font-serif text-darkgray -tracking-[2px] mb-0" {...fadeIn}>
                                    <span className="font-semibold">33,000+</span> Trusted customers
                                </m.h2>
                            </Col>
                        </Row>
                                                    ...
                                                    <div className="feature-box feature-box-left-icon-middle py-12 px-[3.5rem] bg-white border border-mediumgray rounded-[6px] ">
                                                        <div className="flex justify-start align-middle items-center">
                                                            ...
                                                            <div className="testimonials-style-04 feature-box-content">
                                                                <div className="star-rating !text-[13px]">
                    ...
                    <Container>
                        <Row>
                            <Col className="text-center">
                                <span className="font-serif font-semibold text-[70px] leading-[80px] text-white -tracking-[2px] block mb-[6.5rem] shadow-lg md:mb-20 xs:-tracking-[.5px] md:text-[54px] md:leading-[64px] xs:text-[35px] xs:leading-[42px] ">Create innovative website today. Purchase Litho template now! </span>
                                <Buttons href="https://1.envato.market/AL7Oj" target="_blank" className="btn-fancy font-medium mb-40 tracking-[1px] font-serif uppercase rounded-[2px] lg:mb-[44px]" themeColor={["#556fff", "#ff798e"]} size="xl" color="#fff" title="Purchase template" />
